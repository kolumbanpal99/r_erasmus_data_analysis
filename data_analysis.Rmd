...
```{r}
# Despite the fit of the model_log_ols model, we were thinking a lot about the potential cause of the extreme outliers and decided to filter the projects excluding the 95% range of the data.
# This way we lost about 14 % of the participants who were in the 5% of the projects we excluded
# Usage of exclusion can be reasoned by the model fit analysis, as it showed outliers in the 2 ends of the scales even after using log transformation which is a dedicated method to deal with right skewed data.
